...
<body class="bg-gray-300">
    <main>
        <nav class="p-5 px-28 bg-gray-800 text-white flex justify-between mb-4">
            ...
            <ul class="flex mx-9 item-center">
                @auth
                    <li><a href="{{ route('profile') }}" class="p-3">{{ auth()->user()->fname }}
                            {{ auth()->user()->lname }}</a></li>
    ...
    <script script src="{{ asset('js/app.js') }}" crossorigin="anonymous"></script>
    <script script src="{{ asset('js/script.js') }}" crossorigin="anonymous"></script>
</body>
